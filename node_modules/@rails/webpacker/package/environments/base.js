...
const { isNotObject, prettyPrint } = require('@rails/webpacker/package/utils/helpers')
const deepMerge = require('@rails/webpacker/package/utils/deep_merge')

const { ConfigList, ConfigObject } = require('@rails/webpacker/package/config_types')
const rules = require('@rails/webpacker/package/rules')
